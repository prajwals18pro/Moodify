...
function findMusic() {
    ...
    if (!songs[selectedLanguage]) {
        alert("Sorry! Songs are not available yet.");
        return;
    }

    const recommendedSongs =
        songs[selectedLanguage][selectedMood];
    ...
    recommendedSongs.forEach(function(song, index) {
        ...
        songHTML += `
            <div class="song-card">
                ...
                <button
                    class="favorite-btn"
                    onclick="toggleFavorite(this, '${songName.replace(/'/g, "\\'")}')">
                    ♡
                </button>
